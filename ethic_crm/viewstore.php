										...
										<table class="table datatable table-bordered table-striped table-actions">
											<thead>
												<tr>
													...
													<th width='58'><span>S. No.</span></th>
													<th width='50'><span>Picture</span></th>
													<th width='50'><span>Name</span></th>
													<th width='200'><span>Address</span></th>
													<th width='50'><span>Timing</span></th>
													<th width='50'><span>Contact</span></th>
													<th width='50'><span>Email</span></th>
													<th width='200'><span>Map</span></th>
											...
											<tbody>
												...
												?>
														<tr id="<?php echo $row[0]; ?>">
															<?php
															echo "<td>$j</td>";
															echo "<td><img src='../" . htmlspecialchars($row[6]) . "' width='100px' height='100px' /></td>";
