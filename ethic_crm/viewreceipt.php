<?php
	...
	$msg=$msg1=$msg2="";
	 ...
	 {
	 	$pid1=mysqli_query($con,"select relatedwith from receipt where rec_id=$_REQUEST[rec_id]");
		$pid=mysqli_fetch_row($pid1);
		$rid=$pid[0];
		mysqli_query($con,"delete from receipt where rec_id=$_REQUEST[rec_id]");
...
<head>        
	...
	{
			var path="viewreceipt.php?rec_id="+row;
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <!-- START PAGE SIDEBAR -->
             <?php $menu12=true; $smenu12="2"; include_once("sidebar.php"); ?>
            <!-- END PAGE SIDEBAR -->
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="#" onclick="window.location=document.referrer;">Back</a></li>
                    ...
                    <li><a href="#">Receipt Master</a></li>
                    <li class="active">View Receipt Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
									 <form class="form-horizontal" method="post" action="viewreceipt.php" name='frm2' enctype="multipart/form-data">
										<div class="form-group">
											<div class="row">
												<label class="col-md-2 col-xs-2">Rec. No.</label>
												...
												<label class="col-md-1 col-xs-">Amount</label>
											...
											<div class="row">
												<div class="col-md-2 col-xs-12">  
												 ...
												 <select class="form-control" name="party" id="party">
													...
													<?php
														$d1=mysqli_query($con,"select * from ledger_accounts  order by name");
...
{
  $sql = "SELECT * FROM receipt where recno like '%$_REQUEST[recno]%' and amount like '$_REQUEST[amount]%' and remark like '%$_REQUEST[remark]%' ".$party." and rdate>='$_REQUEST[dfrom]' and rdate<='$_REQUEST[dto]' order by rdate desc";
} 	
else if($_REQUEST['dfrom']!="")
{
	$sql = "SELECT * FROM receipt where recno like '%$_REQUEST[recno]%'  and amount like '$_REQUEST[amount]%' and remark like '%$_REQUEST[remark]%' ".$party." and rdate>='$_REQUEST[dfrom]' order by rdate desc";
}
else if($_REQUEST['dto']!="")
{
	$sql = "SELECT * FROM receipt where recno like '%$_REQUEST[recno]%'  and amount like '$_REQUEST[amount]%' and remark like '%$_REQUEST[remark]%' ".$party." and rdate<='$_REQUEST[dto]' order by rdate desc";
}
else
{
	$sql = "SELECT * FROM receipt where recno like '%$_REQUEST[recno]%'  and amount like '$_REQUEST[amount]%' and remark like '%$_REQUEST[remark]%' ".$party." order by rdate desc";
} 
...
?>
 ...
 <?php	
		...
		<?php				
				...
				if($row[4]=="credit")
				{
					echo "<td>By Credit</td>";
					$table .="<td style='padding-left:10px;'>By Credit</td>";
				}
				else
				{
				...
				$table .=  "<td style='padding-left:10px;'>".htmlspecialchars($row[5])."</td>
					<td style='padding-left:10px;'>".htmlspecialchars($row[8])."</td></tr>";
				?>
				<td>
					...
					<button class="btn btn-success btn-rounded btn-condensed btn-sm" onClick="window.open('printreceipt.php?rec_id=<?php echo $row[0]; ?>','_blank');"><span class="fa fa-print"></span></button>
				</td>
			</tr>
			<?php
				$j++;
	...
	?>	
		...
		<div class="col-md-3 col-xs-3">
			<form action="excel.php" method="post">
				 ...
				 <input type="hidden" name="fn" value="Receipt Details"/>
