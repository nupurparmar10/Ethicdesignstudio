            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
				   ...
				   <li><a href="viewsales.php">Sales Master</a></li>
                    <li class="active">View Sales Bill</li>
                </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                   <h2><span class="fa fa-lsit"></span>Sales Bill Details</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="content-frame-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="post" action="saledet.php" enctype="multipart/form-data" onsubmit="return confirm('Sure?');">
											...
											<table class="table table-bordered table-striped table-actions">
												<tbody>  
													...
													<tr>
														<th>Payment Mode</th>
														<td><?php 
															if($p[7]=="Credit") echo "By Credit";
															else
															{
																$r=mysqli_fetch_row(mysqli_query($con,"select name from ledger_accounts where ledger_id='$p[7]'"));
																echo $r[0]; 
															}
														?></td>
														<th>Mobile No.</th>
													...
													<tr>
														<th>Sales Person</th>
														<td><?php 
														$emp1=mysqli_query($con,"select empname from empdet where ledger_id='$p[17]'");
														...
														<td colspan='4'>
															...
															<table class="table table-bordered table-striped table-actions" id="input_fields">
																...
																<?php
																	...
																	$k1=mysqli_query($con,"select * from bill_items where sale_id='$_REQUEST[sale_id]'");
