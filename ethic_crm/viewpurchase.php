<?php
	...
	{
		$msg="Purchase Bill Modified Successfully!!!";
	}
	...
	{		
		...
		mysqli_query($con,"delete from purbook where pur_id='$_REQUEST[pur_id]'");
		$msg1="Purchase Bill Deleted Successfully!!!";
	}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>        
	...
	{
		var path="viewpurchase.php?pur_id="+row;
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <!-- START PAGE SIDEBAR -->
             <?php  $menu9=true; $smenu9="5"; include_once("sidebar.php"); ?>
            <!-- END PAGE SIDEBAR -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                   <form class="form-horizontal" method="post" action="viewpurchase.php" name='frm2' enctype="multipart/form-data">
  ...
  if(isset($_REQUEST['open']))
  {
	...
	$sql="select * from purbook where invno like '%$_REQUEST[invno]%' ".$paidby." ".$dfrom." ".$dto." ".$party." order by invdate desc";
			...
			?>
				 <tr id="<?php echo $d[0]; ?>">
					...
					<?php
						...
						$tax=mysqli_fetch_row(mysqli_query($con,"select sum((stock*purrate) - (stock*purrate)*dis/100), sum(((stock*purrate) - (stock*purrate)*dis/100)*tax/100) from pur_items where pur_id=$d[0]"));
						$gst=round($tax[1]/2,2);
					?>
					<td><?php echo $p[0]; ?></td>
					<td><?php echo $d[3]; ?></td>
					...
					?>
					<td>
						<button class="btn btn-info btn-rounded btn-condensed btn-sm" onClick="window.open('addpurchase.php?pur_id=<?php echo $d[0]; ?>','_self');"><span class="fa fa-pencil"></span></button>
						...
						<button class="btn btn-warning btn-rounded btn-condensed btn-sm" onClick="window.open('purdet.php?pur_id=<?php echo $d[0]; ?>','_self');"><span class="fa fa-list"></span></button>
					</td>
				</tr>
			<?php
					$table .= "</tr>";
