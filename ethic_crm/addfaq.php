...
if (isset($_REQUEST['s1'])) {
    ...
    mysqli_query($con, "insert into faq set title='$_REQUEST[question]', desp='$_REQUEST[answer]'");

    $msg = "FAQ's added successfully!!!";
}
if (isset($_REQUEST['s3'])) {
    mysqli_query($con, "update faq set title='$_REQUEST[question]', desp='$_REQUEST[answer]' where f_id='$_REQUEST[f_id]'");
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="question" value='<?php echo $c[1]; ?>' required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name="answer" value='<?php echo $c[2]; ?>' required />
                                            </div>
                                        </div>
                                    </div>
