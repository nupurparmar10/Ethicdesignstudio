<?php
	...
	if(isset($_REQUEST['s1']))
	{
		...
		$pid1=mysqli_query($con,"select max(pur_id) from purbook");
		...
		for($i=0;$i<$count;$i++)
		{
			...
			if($v_id!="" && $qty>0)
			{
				...
				$dis=$_REQUEST['dis'][$i];
				mysqli_query($con,"insert into pur_items set v_id='$product', `stock`='$qty', `purrate`='$purrate',`tax`='$taxper',`edsellrate`='$edsellrate', pur_id='$id', dis='$dis'");
				mysqli_query($con,"update variant set stock=stock+$qty, purrate='$purrate', edsellrate='$edsellrate' where v_id='$product'");
			}
		}
		
		mysqli_query($con,"insert into purbook set pur_id=$id, party='".$party."', invno='".$_REQUEST['invno']."', invdate='".$invdate."', paidby='".$paidby."', roundoff='$_REQUEST[roundoff]', amount='".$amt."',  relatedwith='$rid', spdis='$_REQUEST[spdis]', freight='$_REQUEST[freight]', remark='$_REQUEST[remark]', transport='$_REQUEST[transport]', other='$_REQUEST[other]', oname='$_REQUEST[oname]'");
		
		$cmp1=mysqli_query($con,"select max(trans_id) from transaction");
		$cmp=mysqli_fetch_row($cmp1);
		$tid=$cmp[0]+1;
		
		mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$invdate."', ledger_id='".$party."', amount='".($amt+(float)$_REQUEST['spdis'])."', particulars='Purchase. $cheque Inv. No. :$_REQUEST[invno]', type='Cr.', relatedto='$rid'");
		
		
		if($paidby!="Credit")
		{
			$tid++;
			mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$invdate."', ledger_id='".$paidby."', amount='".$amt."', particulars='Purchase. $cheque Inv. No. :$_REQUEST[invno]', 	type='Cr.', relatedto='$rid'");	
			$tid++;
			mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$invdate."', ledger_id='".$party."', amount='".$amt."', particulars='Amount Paid $cheque Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");	
		}
		$tid++;		
		$amt=(float)$amt-+(float)$_REQUEST['spdis']-(float)$_REQUEST['freight']-(float)$_REQUEST['transport']-(float)$_REQUEST['other']-$_REQUEST['taxtot'];
		
		mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$invdate."', ledger_id='1', amount='".($amt)."', particulars='$cheque Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");	
		...
		if($_REQUEST['taxtot']>0)
		{
			...
			mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$invdate."', ledger_id='7', amount='".$tax."', particulars='$_REQUEST[chequeno] Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");			
			$tid++;
			mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$invdate."', ledger_id='8', amount='".$tax."', particulars='$_REQUEST[chequeno] Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");
		}

		if($_REQUEST['spdis']>0)
		{
			$tid++;
			mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$invdate."', ledger_id='6', amount='".$_REQUEST['spdis']."', particulars='$_REQUEST[chequeno] Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");
		}
		if($_REQUEST['freight']>0)
		{
			$tid++;
			mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$invdate."', ledger_id='9', amount='".$_REQUEST['freight']."', particulars='$_REQUEST[chequeno] Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");
		}
		if($_REQUEST['transport']>0)
		{
			$tid++;
			mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$invdate."', ledger_id='12', amount='".$_REQUEST['transport']."', particulars='$_REQUEST[chequeno] Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");
		}
		if($_REQUEST['other']>0)
		{
			$tid++;
			mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$invdate."', ledger_id='14', amount='".$_REQUEST['other']."', particulars='$_REQUEST[chequeno] Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");
		}
		$tid++;
		...
		if($roundoff!=0.00)
		{
			if($_REQUEST['roundoff']<0)
			{
				...
				mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$invdate."', ledger_id='13', amount='".$r."', particulars='$cheque Inv. No. :$_REQUEST[invno]', type='Cr.', relatedto='$rid'");	
			}
			else
			{
				$r=$roundoff;
				mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$invdate."', ledger_id='13', amount='".$r."', particulars='$cheque Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");	
			}
		}
		header("Location: addpurchase.php?msg=set"); die;
	}
	if(isset($_REQUEST['s3']))
	{
		$old=mysqli_fetch_row(mysqli_query($con,"select relatedwith from purbook where pur_id='$_REQUEST[pur_id]'"));
		
		$p1=mysqli_query($con,"select * from pur_items where pur_id='$_REQUEST[pur_id]'");
		while($p=mysqli_fetch_row($p1))
		{
			mysqli_query($con,"update variant set stock=stock-$p[1] where v_id='$p[0]'");
		}
		mysqli_query($con,"delete from pur_items where pur_id='$_REQUEST[pur_id]'");
		...
		mysqli_query($con,"update purbook set party='".$party."', invno='".$_REQUEST['invno']."', invdate='".$invdate."', paidby='".$paidby."', roundoff='$_REQUEST[roundoff]', amount='".$amt."',  relatedwith='$rid', spdis='$_REQUEST[spdis]', freight='$_REQUEST[freight]', remark='$_REQUEST[remark]',  transport='$_REQUEST[transport]', other='$_REQUEST[other]', oname='$_REQUEST[oname]' where pur_id='$id'");
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
				   ...
				   <li><a href="viewpurchase.php">Purchase Master</a></li>
                    <li class="active">Add Purchase Bill</li>
                </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                   <h2><span class="fa fa-lsit"></span><?php if(isset($_REQUEST['pur_id'])) echo "Modify Purchase Bill"; else echo "Add New Bill"; ?></h2>
				   <br><br><br>
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="content-frame-body">
                        ...
                        <div class="col-md-12">
							...
							?>
                            <form class="form-horizontal" method="post" action="addpurchase.php" enctype="multipart/form-data" onsubmit="return confirm('Sure?');" name='frm2'>
									...
									<div class="row">
										...
										<div class="table-responsive">
											<table class="table table-bordered table-striped table-actions">
												<tbody>  
													<tr>
														<th width="10%">Vendor Invoice No.</th>
													...
													<tr>
														...
														<td width='35%' colspan='3'><div class="form-group" style='width:89%; float:left;'>
															...
															</div><span style='position:relative; float:right; width:10%;'><button type="button" name="add_data1" id="add_data1" class="btn btn-success btn-xs"><i class="fa fa-plus"></i></button></span>
														</td>
													...
													<tr>
														<td colspan='4' style="max-width:300px; overflow-x:auto;">
															...
															<table class="table table-bordered table-striped table-actions" id="input_fields">
																...
																<tbody>
																	...
																	<tr id="<?php echo $a; ?>">
																		...
																		<td> <div class="form-group">
																			<input type="text" class="form-control" name="qty[]" onkeyup="calc();" tabindex='1' value='<?php echo $k[1]; ?>'/>
																		</div></td>
																		<td> <div class="form-group">
																			<input type="text" class="form-control" name="purrate[]" onkeyup="calc();" tabindex='1' value='<?php echo $k[2]; ?>'/>
																		</div></td>
																		<td> <div class="form-group">
																		...
																		<td> <div class="form-group">
																			<input type="text" class="form-control" name="taxper[]" onkeyup="calc();" value='<?php echo $k[3]; ?>'/>
																		</div></td>
																		<td> <div class="form-group">
																		...
																		<td> <div class="form-group">
																			<input type="text" class="form-control" name="sellamt[]" onkeyup="calc();"/>
																		</div></td>
																		<td> <div class="form-group">
																			<input type="text" class="form-control" name="edsellrate[]" onkeyup="calc();" tabindex='1' value='<?php echo $k[4]; ?>'/>
																		</div></td>
																	...
																	<tr id="<?php echo $i; ?>">
																		...
																		<td> <div class="form-group">
																			<input type="text" class="form-control" name="edsellrate[]" onkeyup="calc();" tabindex='1'/>
																		</div></td>
																		<td><a onclick='delete_row(0);'><i class='fa fa-times'></i></a></td>
																	</tr>
																	<?php
															...
															</div>														<span ><button type="button" name="add_data" id="add_data" class="btn btn-success btn-xl" tabindex='1'>Add New Product</button></span>
														</td>
													</tr>
													<tr>
    ...
    },
    {
     ...
     click:function(e)
     {
		if($('#ptype').val() == "Garments")
		{
			...
			var standard_color = document.getElementsByName("standard_color[]");
		...
		else
		{
			...
			form_data.append('product_desp', $('#product_desp').val());
			form_data.append('color', val1);
			form_data.append('standard_color', val3);
