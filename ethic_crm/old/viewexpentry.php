<?php
	...
	{
		$msg="Expense Entry Modified Successfully!!!";
	}
	if(isset($_REQUEST['exp_id']))
	{
		...
		$rid=$pid[0];
		mysqli_query($con,"delete from expense_detail where exp_id=$_REQUEST[exp_id]");
		mysqli_query($con,"delete from transaction where relatedto='$rid'");
		$msg1="Expense Entry Deleted Successfully!!!";
	}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>        
	...
	{
			var path="viewexpentry.php?exp_id="+row;
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <!-- START PAGE SIDEBAR -->
             <?php $menu5=true; $smenu5="2";  $ssmenu5="22"; include_once("sidebar.php"); ?>
            <!-- END PAGE SIDEBAR -->
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="#" onclick="window.location=document.referrer;">Back</a></li>
                    ...
                    <li class="active">View Expense Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
									 <form class="form-horizontal" method="post" action="viewexpentry.php" name='frm2' enctype="multipart/form-data">
										<div class="form-group">
											<div class="row">
												<label class="col-md-2 col-xs-2">Expense Type</label>
												<label class="col-md-2 col-xs-2">Date From</label>
												<label class="col-md-2 col-xs-2">Date To</label>
												<label class="col-md-2 col-xs-2">Paid By</label>
...
$sql = "SELECT * FROM expense_detail where remark like '%$_REQUEST[remark]%' and amount like '$_REQUEST[amount]%' ".$ledger_id." ".$dfrom." ".$dto." ".$paidby." ".$party." order by exp_id desc";
	...
	{
		echo "There is no Expense Entry Available!!!";
	}
	else
	{
		...
		<table class="table table-bordered table-striped table-actions">
			<thead>
				<tr>
					...
					<th style='width:100px;'>Party</th>
					<th style='width:10px;'>Expense Type</th>
					<th style='width:150px;'>Amount</th>
					<th style='width:100px;'>Paid By</th>
					<th style='width:100px;'>Date</th>
					<th style='width:100px;'>Remark</th>
 ...
 <?php	
		...
		{		
			...
			<tr id="<?php echo $d[0]; ?>">
				...
				<td>
					<button class="btn btn-info btn-rounded btn-condensed btn-sm" onClick="window.open('addexpentry.php?exp_id=<?php echo $d[0]; ?>','_self');"><span class="fa fa-pencil"></span></button>
	...
	?>							
		...
		<div class="col-md-3 col-xs-3">
			<form action="excel.php" method="post">
				 ...
				 <input type="hidden" name="fn" value="Expense Details"/>
