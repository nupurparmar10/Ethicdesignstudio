				...
				<ul>
					<li class="xn-openable <?php if ($smenu13 == "1") {
						...
						<ul>
							...
							<li <?php if ($ssmenu13 == "3") { ?> class="active" <?php } ?>><a href="upamenities.php">Amenities</a></li>
						</ul>
					</li>
					<li class="xn-openable <?php if ($smenu13 == "2") {
						...
						<ul>
							<li <?php if ($ssmenu13 == "1") { ?> class="active" <?php } ?>><a href="uplabel.php">Label</a></li>
					...
					<li class="xn-openable <?php if ($smenu13 == "4") {
						...
						<ul>
							...
							<li class="xn-openable <?php if ($ssmenu13 == "10") {
														echo 'active';
													} ?>"><a href="#"><span class="fa fa-question-circle"></span>FAQ's</a>

								<ul>
									<li <?php if ($sssmenu13 == "1") { ?> class="active" <?php } ?>><a href="addfaq.php">Add FAQ's</a></li>
									<li <?php if ($sssmenu13 == "2") { ?> class="active" <?php } ?>><a href="viewfaq.php">View FAQ's</a></li>
								</ul>
							</li>
							...
							<li <?php if ($ssmenu13 == "2") { ?> class="active" <?php } ?>><a href="uppoint.php">Points</a></li>
							<li <?php if ($ssmenu13 == "3") { ?> class="active" <?php } ?>><a href="upmarquee.php">Message Slider</a></li>
							<li <?php if ($ssmenu13 == "4") { ?> class="active" <?php } ?>><a href="upbanner.php">Banners</a></li>
