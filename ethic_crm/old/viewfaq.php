...
if (isset($_REQUEST['f_id'])) {
	mysqli_query($con, "delete from faq where f_id='$_REQUEST[f_id]'");
	$msg1 = "FAQ Deleted successfully!!!";
}
?>
<!DOCTYPE html>
<html lang="en">
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form class="form-horizontal" method="post" action="viewfaq.php" name='frm2' enctype="multipart/form-data">
										...
										<div class="row">
											<div class="col-md-2 col-xs-8">
												<select class="form-control" name="group">
													...
													<?php
													$c1 = mysqli_query($con, "select distinct(title) from faq");
								...
								<div class="table-responsive" id="display">
									...
									if (isset($_REQUEST['open'])) {
										...
										if (!empty($_REQUEST['group'])) {
											$group = " AND title = '" . mysqli_real_escape_string($con, $_REQUEST['group']) . "'";
										}

										$sql = "SELECT * FROM faq WHERE 1 $group ORDER BY f_id";
										...
										if (mysqli_num_rows($result) == 0) {
											...
											$table = "<table width='100%' border='1' align='center' style='border-collapse:collapse;'>
														<caption><h1>FAQ's</h1></caption>
														<tr>
															<th width='58'><span>S. No.</span></th>
															<th width='189'><span>Group</span></th>	
															<th width='189'><span>Question</span></th>	
															<th width='169'><span>Answer</span></th>	
														</tr>";
									?>
												...
												<tbody>
													...
													?>
															<tr id="<?php echo $row[0]; ?>">
																...
																?>
																<td>
																	<button type="button" class="btn btn-info btn-rounded btn-condensed btn-sm" onClick="window.open('addfaq.php?f_id=<?php echo $row[0]; ?>','_self');" title="Edit"><span class="fa fa-pencil"></span></button>
											...
											<div class="col-md-3 col-xs-3">
												<form action="excel.php" method="post">
													...
													<input type="hidden" name="fn" value="FAQ's" />
