...
if (isset($_REQUEST['s1'])) {
    ...
    mysqli_query($con, "insert into event set title='$_REQUEST[title]', place='$_REQUEST[place]', event_date='$_REQUEST[event_date]', event_time='$_REQUEST[event_time]',address='$_REQUEST[address]'");

    $msg = "Event added successfully!!!";
}
if (isset($_REQUEST['s3'])) {
    mysqli_query($con, "update event set title='$_REQUEST[title]', place='$_REQUEST[place]', event_date='$_REQUEST[event_date]', event_time='$_REQUEST[event_time]',address='$_REQUEST[address]' where e_id='$_REQUEST[e_id]'");
