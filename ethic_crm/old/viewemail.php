	...
	if (isset($_POST['send_message'])) {
		...
		foreach ($emails as $email) {
			...
			try {
				...
				$mail->SMTPAuth   = true;
				$mail->Username   = 'belimadnan111@gmail.com';
				$mail->Password   = 'uriecbkuocdiagpj';
				$mail->SMTPSecure = 'tls';
				$mail->Port       = 587;

				$mail->setFrom('belimadnan111@gmail.com', 'Ethic Studio');
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="table-responsive" id="display">
									...
									?>
										<form action="viewemail.php" method="post">
											...
											<div>
												<textarea name="universal_message" style="margin-top: 20px;" class="form-control"></textarea>
