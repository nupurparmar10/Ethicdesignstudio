...
if (isset($_GET['update_id']) && isset($_GET['value'])) {
    ...
    $check_query = "SELECT * FROM collection WHERE name = '$value' AND c_id != $id";
    $check_result = mysqli_query($con, $check_query);

    if (mysqli_num_rows($check_result) > 0) {
        $msg1 = "This value already exists.";
    } else {
        $sql = "UPDATE collection SET name = '$value' WHERE c_id = $id";
...
if (isset($_GET['delete_id'])) {
    ...
    mysqli_query($con, "UPDATE collection set status = 0 WHERE c_id='$id'");
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($value)) {
        ...
        $check = mysqli_query($con, "SELECT * FROM collection WHERE name = '$value'");

        if (mysqli_num_rows($check) > 0) {
            $msg1 = "This value already exists.";
        } else {
            mysqli_query($con, "INSERT INTO collection (name) VALUES ('$value')");
    ...
    <script type="text/javascript">
        function delete_row(row) {
            ...
            box.find(".mb-control-yes").off("click").on("click", function() {
                ...
                window.location.href = "upcollection.php?delete_id=" + row;
            });
        }
        ...
        function updateValue(id) {
            ...
            console.log(value);
            window.location.href = `upcollection.php?update_id=${id}&value=${encodedValue}`;
        }
    </script>
</head>
            ...
            <div class="page-content-wrap">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php
                        $result = mysqli_query($con, "SELECT * FROM collection WHERE status = 1 ORDER BY c_id ASC");
                        $data = [];
                        ...
                        <form class="form-horizontal" method="post" action="upcollection.php">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Add</strong> Collection</h3>
                                </div>
