! function(t) {
    ...
    var r = function() {
        ...
        }, t.prototype.handleSpecialCharacter = function(t, e) {
            var n, r;
    ...
    var r = function() {
        ...
        return t.prototype.getEncoding = function(t) {
            ...
            if (this.mod43Enabled) {
                var r = this.mod43checksum();
                e += this.getBinary(r) + "0", t += this.getCharacter(r)
            }
        ...
        }, t.prototype.mod43checksum = function() {
            for (var t = 0, e = 0; e < this.string.length; e++) t += this.characterValue(this.string[e]);
            return t %= 43
        }, t
    }();
    e.CODE39 = r
    ...
    var o = n(2),
        ...
        u = function() {
            ...
            return t.prototype.render = function() {
                ...
                if (t.displayValue) {
                    var o, s;
                    s = "top" == t.textPosition ? t.marginTop + t.fontSize - t.textMargin : t.height + t.textMargin + t.marginTop + t.fontSize, n.font = r, "left" == t.textAlign || e.barcodePadding > 0 ? (o = 0, n.textAlign = "left") : "right" == t.textAlign ? (o = e.width - 1, n.textAlign = "right") : (o = e.width / 2, n.textAlign = "center"), n.fillText(i, o, s)
                }
    ...
    function a(t, e, n, r, i, o) {
        console.log(i);
        var s = document.createElementNS(h, "rect");
        s.setAttribute("x", t + (1 - i) * n / 2), s.setAttribute("y", e), s.setAttribute("width", n * i), s.setAttribute("height", r), o.appendChild(s)
    }
    Object.defineProperty(e, "__esModule", {
        value: !0
    });
    var u = n(2),
        ...
        l = function() {
            ...
            return t.prototype.render = function() {
                ...
                for (var o = 0, s = 0, u = 0; u < i.length; u++) s = u * e.width + n.barcodePadding, "1" === i[u] ? o++ : o > 0 && (a(s - e.width * o, r, e.width * o, e.height, e.ratio, t), o = 0);
                o > 0 && a(s - e.width * (o - 1), r, e.width * o, e.height, e.ratio, t)
            }, t.prototype.drawSVGText = function(t, e, n) {
                var r = document.createElementNS(h, "text"),
                    i = e.text || n.text;
                if (e.displayValue) {
                    var o, s;
                    r.setAttribute("style", "font:" + e.fontOptions + " " + e.fontSize + "px " + e.font), s = "top" == e.textPosition ? e.fontSize - e.textMargin : e.height + e.textMargin + e.fontSize, "left" == e.textAlign || n.barcodePadding > 0 ? (o = 0, r.setAttribute("text-anchor", "start")) : "right" == e.textAlign ? (o = n.width - 1, r.setAttribute("text-anchor", "end")) : (o = n.width / 2, r.setAttribute("text-anchor", "middle")), r.setAttribute("x", o), r.setAttribute("y", s), r.appendChild(document.createTextNode(i)), t.appendChild(r)
                }
    ...
    var u = n(8),
        ...
        E = function(t, e, n) {
            ...
            return r._renderProperties = (0, y["default"])(t), r._encodings = [], r._options = w["default"], r._errorHandler = new m["default"](r), "undefined" != typeof e && (n = n || {}, n.format || (n.format = s()), r.options(n)[n.format](e, n).render()), r
        };
