...
if (isset($_REQUEST['e_id'])) {
	mysqli_query($con, "update event set status = 0 where e_id='$_REQUEST[e_id]'");
	$msg1 = "Event Deleted successfully!!!";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
	...
	<script type="text/javascript" language="javascript">
		...
		function delete_row1(row) {
			var path = "viewevent.php?e_id=" + row;
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form class="form-horizontal" method="post" action="viewevent.php" name='frm2' enctype="multipart/form-data">
										...
										<div class="row">
											<div class="col-md-2 col-xs-8">
												<select class="form-control" name="place">
													...
													<?php
													$c1 = mysqli_query($con, "select distinct(place) from event");
								...
								<div class="table-responsive" id="display">
									...
									if (isset($_REQUEST['open'])) {
										...
										if (!empty($_REQUEST['place'])) {
											$place = " AND place = '" . mysqli_real_escape_string($con, $_REQUEST['place']) . "'";
										}

										$sql = "SELECT * FROM event WHERE status = 1" . $place . " ORDER BY e_id";
										...
										if (mysqli_num_rows($result) == 0) {
											...
											$table = "<table width='100%' border='1' align='center' style='border-collapse:collapse;'>
														<caption><h1>Event</h1></caption>
														<tr>
															<th width='58'><span>S. No.</span></th>
															<th width='189'><span>Title</span></th>	
															<th width='189'><span>Place</span></th>	
															<th width='169'><span>Address</span></th>
															<th width='169'><span>Time</span></th>
															<th width='169'><span>Date</span></th>
														</tr>";
									?>
												...
												<tbody>
													...
													?>
															<tr id="<?php echo $row[0]; ?>">
																...
																?>
																<td>
																	<button type="button" class="btn btn-info btn-rounded btn-condensed btn-sm" onClick="window.open('addevent.php?e_id=<?php echo $row[0]; ?>','_self');" title="Edit"><span class="fa fa-pencil"></span></button>
											...
											<div class="col-md-3 col-xs-3">
												<form action="excel.php" method="post">
													...
													<input type="hidden" name="fn" value="Event" />
