<?php
	...
	{
		$msg="Service Job Generated Successfully!!!";
	}
	if(isset($_REQUEST['s1']))
	{
		...
		for($i=0;$i<$count;$i++)
		{
			...
			if($item_id!="" && $qty>0)
			{
				...
				mysqli_query($con,"insert into manu_product set m_id='$id',v_id='$item', qty='$qty', rate='$rate', remark='$remarks'");
			}
		}
		
		mysqli_query($con,"insert into manufacturejob set m_id='$id', mdate='$_REQUEST[mdate]', jobber='$_REQUEST[jobber]', remark='$_REQUEST[remark]', relatedwith='$rid', status=0, type='$_REQUEST[type]'");
		header("Location: addmanu1.php?msg=set"); die;
	}
?>
<!DOCTYPE html>
<html lang="en">
 ...
 function more() {
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <!-- START PAGE SIDEBAR -->
             <?php  $menu15=true; $smenu15="4"; include_once("sidebar.php"); ?>
            <!-- END PAGE SIDEBAR -->
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
				   ...
				   <li><a href="viewmanu.php">Job Master</a></li>
                    <li class="active">Generate Service Job</li>
                </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                   <h2><span class="fa fa-lsit"></span>Generate Service Job</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="content-frame-body">
                        ...
                        <div class="col-md-12">
							...
							?>
                            <form class="form-horizontal" method="post" action="addmanu1.php" enctype="multipart/form-data" onsubmit="return chk();" name='frm2'>
											...
											<table class="table table-bordered table-striped table-actions">
												<tbody>  
													<tr>
														...
														<td width='30%'><div class="form-group" style='width:89%; float:left;'>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td><select class="form-control" name="item_id[]" onchange="getvalues(this.value);" id="item_id1">
                                                                            <option value="">--Select--</option>
                                                                            <?php
                                                                                $f1=mysqli_query($con,"select * from variant where stock>0");
                                                                                while($f=mysqli_fetch_row($f1))
                                                                                {
																					$item=mysqli_fetch_row(mysqli_query($con,"select * from item_details where item_id='$f[1]'"));
                                                                                    echo "<option value='$f[0]-$f[5]-$f[6]'>$item[1]-$f[3]-$f[2]</option>";
                                                                                }
                                                                            ?>
                                                                        </select></td>
                                                                        <td> <div class="form-group">
   ...
   .buttons([
    ...
    },
    {
     ...
     click:function(e)
     {
      ...
      form_data.append('desig', $('#design').val());
      form_data.append('tinno', $('#tinno').val());
      form_data.append('phone', $('#phone').val());
      form_data.append('fax', $('#fax').val());
	  ...
	  form_data.append('opbal', $('#opbal').val());
