												...
												?>
														<tr id="<?php echo $row[0]; ?>">
															...
															<td class="d-flex gap-5">
																...
																<select class="form-select form-select-sm" onchange="changeReviewStatus('<?php echo $row[0]; ?>', this.value)">
																	<option value="1" <?php if ($row[6] == 1) echo 'selected'; ?>>Show</option>
																	<option value="0" <?php if ($row[6] == 0) echo 'selected'; ?>>Hide</option>
																</select>
															</td>
