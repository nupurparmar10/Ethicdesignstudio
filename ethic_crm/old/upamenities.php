...
if (isset($_POST['update'])) {
    ...
    $msg = "Home Amenities Update Successfully";
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Update Home Amenities</li>
            </ul>
            <!-- END BREADCRUMB -->
            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        $result = mysqli_query($con, "SELECT * FROM matter WHERE m_id BETWEEN 32 AND 37");
                        ...
                        <form class="form-horizontal" method="post" action="upamenities.php" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Update</strong> Amenities</h3>
                                </div>
