...
if (isset($_REQUEST['update'])) {
    ...
    $query = "UPDATE matter SET title = '$title', desp = '$desp' WHERE m_id = 4";
            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        $result = mysqli_query($con, "SELECT * FROM matter WHERE m_id = 4");
                        ...
                        <form class="form-horizontal" method="post" action="uppolicy_privacy.php">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Update</strong> Privacy Policy</h3>
                                </div>
