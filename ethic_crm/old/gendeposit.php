...
if($_REQUEST['dfrom']!="") $dfrom=" and d_date>='$_REQUEST[dfrom]'"; else $dfrom="";
if($_REQUEST['dto']!="") $dto=" and d_date<='$_REQUEST[dto]'"; else $dto="";
if($_REQUEST['bank']!="") $bank=" and bank_acc='$_REQUEST[bank]'"; else $bank="";

$sql = "SELECT * FROM deposit where amt like '$_REQUEST[amt]%' and remark like '%$_REQUEST[remark]%' ".$bank." ".$dfrom." ".$dto." order by d_id desc";
	...
	{
		echo "There is no Deposit Entry Available!!!";
	}
	else
	{
 ...
 <?php	
		...
		{		
			...
			<tr id="<?php echo $d[0]; ?>">
				...
				<td>
					<button class="btn btn-info btn-rounded btn-condensed btn-sm" onClick="window.open('adddeposit.php?d_id=<?php echo $d[0]; ?>','_self');"><span class="fa fa-pencil"></span></button>
	...
	?>							
		...
		<div class="col-md-3 col-xs-3">
			<form action="excel.php" method="post">
				 ...
				 <input type="hidden" name="fn" value="Deposit Details"/>
