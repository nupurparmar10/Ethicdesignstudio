<?php
	...
	{
		header("Location: purreturndet.php?msg=set"); die;
	}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
				   ...
				   <li><a href="viewpurchase.php">Purchase Master</a></li>
                    <li class="active">Purchase Return Detail</li>
                </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                   <h2><span class="fa fa-lsit"></span>Purchase Return Detail</h2>
                </div>
                <!-- END PAGE TITLE -->                
													...
													<tr>
														...
														<td><div class="form-group">
                                                            <?php
                                                                ...
                                                                {
																	$list1=mysqli_query($con,"select ledger_id,name from ledger_accounts where (group_id in (select group_id from group_master where group_name='Bank Accounts') or name='Cash Account') and status=1 and ledger_id='$p[5]' order by name");
															...
															<table class="table table-bordered table-striped table-actions" id="input_fields">
																...
																<tbody>
																	<?php
																		if(isset($_REQUEST['pur_id']))
																		{
																			$k1=mysqli_query($con,"select * from pr_items where pur_id='$p[0]'");
                                                                    ...
                                                                    <tr id="0">
																		<td align="left" valign="middle">
                                                                            <?php
																					$f1=mysqli_query($con,"select * from variant where item_id in (select item_id from item_details where status=1) and v_id='$k[1]'");
																		...
																		<td> <div class="form-group">
																			<input type="text" class="form-control" name="qty[]" onkeyup="calc();" value='<?php echo $k[2]; ?>' readonly style="color:black !important;" />
																		</div></td>
																		<td> <div class="form-group">
																			<input type="text" class="form-control" name="purrate[]" onkeyup="calc();" value='<?php echo $k[3]; ?>' readonly style="color:black !important;" />
																		</div></td>
																		<td> <div class="form-group">
																		...
																		<td> <div class="form-group">
																			<input type="text" class="form-control" name="taxper[]" onkeyup="calc();" value='<?php echo $k[4]; ?>' readonly style="color:black !important;" />
																		</div></td>
																		<td> <div class="form-group">
