<?php
	...
	if(isset($_REQUEST['msg']))
	 {
	 	$msg="Withdrawl Entry Modified Successfully!!!";
	 }
	 if(isset($_REQUEST['w_id']))
	 {
	 	$pid1=mysqli_query($con,"select relatedwith from withdrawl where w_id=$_REQUEST[w_id]");
		$pid=mysqli_fetch_row($pid1);
		$rid=$pid[0];
		mysqli_query($con,"delete from withdrawl where w_id=$_REQUEST[w_id]");
		mysqli_query($con,"delete from transaction where relatedto='$rid'");
		$msg1="Withdrawl Entry Deleted Successfully!!!";
	 }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>        
	...
	{
			var path="viewwithdrawl.php?w_id="+row;
			window.open(path,"_self");
	}
	function genwithdrawl()
    {
 ...
 function ajaxError()
    ...
    <body onload="genwithdrawl();">
        <!-- START PAGE CONTAINER -->
        <div class="page-container">
            
            <!-- START PAGE SIDEBAR -->
             <?php $menu4=true; $smenu4="3";  $ssmenu4="32"; include_once("sidebar.php"); ?>
            <!-- END PAGE SIDEBAR -->
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="#" onclick="window.location=document.referrer;">Back</a></li>
                    ...
                    <li class="active">View Withdrawl Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2> View Withdrawl Details</h2>
                </div>
                <!-- END PAGE TITLE -->                
										...
										<div class="form-group">
											...
											<div class="row">
												 <div class="col-md-2 col-xs-12">  
													<select class="form-control" name="bank" onchange="genwithdrawl();">
													   <?php
												...
												<div class="col-md-2 col-xs-12">  
													<input type="date" class="form-control" name="dfrom" id="dfrom" onchange="genwithdrawl();"/>
												</div>
												<div class="col-md-2 col-xs-12">  
													<input type="date" class="form-control" name="dto" id="dto" onchange="genwithdrawl();"/>
												</div>
												<div class="col-md-2 col-xs-12">  
													<input type="text" class="form-control" name="amt" id="amt" onkeyup="genwithdrawl();"/>
												</div>
												 <div class="col-md-2 col-xs-12">  
													<input type="text" class="form-control" name="remark" id="remark" onkeyup="genwithdrawl();"/>
												</div>
											</div>
									</div>
									 </form>
