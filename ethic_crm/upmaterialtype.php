...
if (isset($_GET['delete_id'])) {
    ...
    mysqli_query($con, "UPDATE material_type set status = 0 WHERE m_id='$id'");
    ...
    <script type="text/javascript">
        function delete_row(row) {
            ...
            box.find(".mb-control-yes").off("click").on("click", function() {
                ...
                window.location.href = "upmaterialtype.php?delete_id=" + row;
            });
        }
            ...
            <div class="page-content-wrap">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php
                        $result = mysqli_query($con, "SELECT * FROM material_type WHERE status = 1 ORDER BY m_id ASC");
                        $data = [];
