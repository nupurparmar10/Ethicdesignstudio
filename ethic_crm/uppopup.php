    ...
    if (!empty($newPic) && is_uploaded_file($_FILES['pic']['tmp_name'])) {
        ...
        if ($imageInfo !== false) {
            ...
            if (isset($extMap[$mime])) {
                $ext = $extMap[$mime];
                $sanitizedFilename = time() . '_21_' . preg_replace("/[^a-zA-Z0-9\._-]/", "", pathinfo(basename($newPic), PATHINFO_FILENAME)) . '.' . $ext;
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <img class="img-fluid" src="../<?php echo htmlspecialchars($pic); ?>" style="height:150px; width:auto; margin-top:20px;" />
                                        </div>
                                    </div>
                                    <div class="form-group">
