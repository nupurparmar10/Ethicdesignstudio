<?php
	...
	if(isset($_REQUEST['s1']))
	{
		...
		$cmp1=mysqli_query($con,"select max(w_id) from withdrawl");
		$cmp=mysqli_fetch_row($cmp1);
			$did=$cmp[0]+1;
		$rid="W".$did;
		mysqli_query($con,"insert into withdrawl set w_id=$did, w_date='$wdate', amt='$amt', bank_acc='$bank', remark='$remark', relatedwith='$rid'");
		...
		mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$wdate."', ledger_id='".$paidto."', amount='".$amt."', particulars='Cash Withdrawl by $a[0]', type='Dr.', relatedto='$rid'");
		$tid++;
		mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$wdate."', ledger_id='".$bank."', amount='".$amt."', particulars='Cash Withdrawl', type='Cr.', relatedto='$rid'");
		
		$msg="Cash Withdrawal Entry Saved Successfully!!!";
	}
	else if(isset($_REQUEST['s3']))
	{
		...
		mysqli_query($con,"update withdrawl set w_date='$wdate', amt='$amt', bank_acc='$bank', remark='$remark' where w_id=$did");
		$a1=mysqli_query($con,"select name from ledger_accounts where ledger_id='$bank'");
		$a=mysqli_fetch_row($a1);
		...
		$tid++;
		mysqli_query($con,"insert into transaction set trans_id='".$tid."', tdate='".$wdate."', ledger_id='".$bank."', amount='".$amt."', particulars='Cash Withdrawl', type='Cr.', relatedto='$rid'");
		header("Location: viewwithdrawl.php?msg=set"); die;
	}	
?>
<!DOCTYPE html>
<html lang="en">
...
<head>        
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <!-- START PAGE SIDEBAR -->
             <?php $menu4=true; $smenu4="3";  $ssmenu4="31"; include_once("sidebar.php"); ?>
            <!-- END PAGE SIDEBAR -->
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="#" onclick="window.location=document.referrer;">Back</a></li>
					...
					<li><a href="#">Withdrawl Entries</a></li>
                    <li class="active"><?php if(isset($_REQUEST['w_id'])) {?>Modify Entry<?php } else { ?>Add Entry<?php }?></li>
                </ul>
                <!-- END BREADCRUMB -->
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							?>
                            <form class="form-horizontal" method="post" action="addwithdrawl.php" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
									<?php
										if(isset($_REQUEST['w_id']))
										{
											$list1=mysqli_query($con,"select * from withdrawl where w_id='$_REQUEST[w_id]'");
											$l=mysqli_fetch_row($list1);
											echo "<input type='hidden' name='w_id' value='$_REQUEST[w_id]'/>";
                                ...
                                <div class="panel-body">   
									...
									<div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">From Bank Account</label>
                                        <div class="col-md-6 col-xs-12">       
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">       
                                            <select class="form-control select" name="paidto" required>
                                               <?php
