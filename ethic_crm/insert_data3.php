...
else
{
    ...
    mysqli_query($con,"insert into ledger_accounts set ledger_id='$id', name='$name', group_id='33', opening_bal='$opbal'");
    
    if($person!=""  || $address!="" || $mobile!="" || $email!="")
    {
        mysqli_query($con,"insert into ledger_details set ledger_id=$id, contact_person='$person',  address='$address',  mobile='$mobile',  email='$email'");
    }
