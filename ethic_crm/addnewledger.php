    ...
    <tr>
        ...
        <td>                                            
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="tinno" style='text-transform:uppercase;' onkeyup="return allowOnly15AlphaNumeric(this);" oninput="allowOnly15AlphaNumeric(this);"/>
