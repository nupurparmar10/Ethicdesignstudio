...
if (isset($_REQUEST['s1']) || isset($_REQUEST['s2']) || isset($_REQUEST['s3'])) {
	if ($_REQUEST['party'] != "")
		...
		$chk1 = mysqli_query($con, "select ledger_id from ledger_accounts where name='$_REQUEST[party1]'");
		if ($chk = mysqli_fetch_row($chk1)) {
			$party = $chk[0];
		} else {
			$l1 = mysqli_query($con, "select max(ledger_id) from ledger_accounts");
			$l = mysqli_fetch_row($l1);
			$l[0] = $l[0] + 1;
			mysqli_query($con, "insert into ledger_accounts set ledger_id='$l[0]', name='$_REQUEST[party1]', group_id='27', status=1, opening_bal=0");
			mysqli_query($con, "insert into ledger_details set ledger_id='$l[0]', tinno='" . strtoupper($_REQUEST['gstin']) . "', mobile='$_REQUEST[chequeno]'");
			$party = $l[0];
		}
	}
	...
	mysqli_query($con, "insert into transaction set trans_id='" . $tid . "', tdate='" . $invdate . "', ledger_id='" . $party . "', amount='" . $amt . "', particulars='Sales. Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");


	if ($paidby != "Credit") {
		$tid++;
		mysqli_query($con, "insert into transaction set trans_id='" . $tid . "', tdate='" . $invdate . "', ledger_id='" . $paidby . "', amount='" . $amt . "', particulars='Sales. Inv. No. :$_REQUEST[invno]', 	type='Dr.', relatedto='$rid'");
		$tid++;
		mysqli_query($con, "insert into transaction set trans_id='" . $tid . "', tdate='" . $invdate . "', ledger_id='" . $party . "', amount='" . $amt . "', particulars='Amount Paid. Inv. No. :$_REQUEST[invno]', type='Cr.', relatedto='$rid'");
	}

	if ($_REQUEST['taxtot'] > 0) {
		$tid++;
		if ($_REQUEST['taxtype'] == "GST") {
			mysqli_query($con, "insert into transaction set trans_id='" . $tid . "', tdate='" . $invdate . "', ledger_id='8', amount='" . ($_REQUEST['taxtot'] / 2) . "', particulars='Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");
			$tid++;
			mysqli_query($con, "insert into transaction set trans_id='" . $tid . "', tdate='" . $invdate . "', ledger_id='7', amount='" . ($_REQUEST['taxtot'] / 2) . "', particulars='Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");
			$tid++;
		} else {
			mysqli_query($con, "insert into transaction set trans_id='" . $tid . "', tdate='" . $invdate . "', ledger_id='4', amount='" . $_REQUEST['taxtot'] . "', particulars='Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");
			$tid++;
		}
	}
	if ($_REQUEST['distot'] > 0) {
		$tid++;
		mysqli_query($con, "insert into transaction set trans_id='" . $tid . "', tdate='" . $invdate . "', ledger_id='6', amount='" . $_REQUEST['distot'] . "', particulars='Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");
	}
	if ($_REQUEST['spdis'] > 0) {
		$tid++;
		mysqli_query($con, "insert into transaction set trans_id='" . $tid . "', tdate='" . $invdate . "', ledger_id='6', amount='" . $_REQUEST['spdis'] . "', particulars='Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");
	}
	if ($_REQUEST['freight'] > 0) {
		$tid++;
		mysqli_query($con, "insert into transaction set trans_id='" . $tid . "', tdate='" . $invdate . "', ledger_id='9', amount='" . $_REQUEST['freight'] . "', particulars='Inv. No. :$_REQUEST[invno]', type='Cr.', relatedto='$rid'");
	}
	if ($_REQUEST['transport'] > 0) {
		$tid++;
		mysqli_query($con, "insert into transaction set trans_id='" . $tid . "', tdate='" . $invdate . "', ledger_id='12', amount='" . $_REQUEST['transport'] . "', particulars='Inv. No. :$_REQUEST[invno]', type='Cr.', relatedto='$rid'");
	}
	if ($_REQUEST['other'] > 0) {
		$tid++;
		mysqli_query($con, "insert into transaction set trans_id='" . $tid . "', tdate='" . $invdate . "', ledger_id='14', amount='" . $_REQUEST['other'] . "', particulars='Inv. No. :$_REQUEST[invno]', type='Cr.', relatedto='$rid'");
	}
	$tid++;
	mysqli_query($con, "insert into transaction set trans_id='" . $tid . "', tdate='" . $invdate . "', ledger_id='2', amount='" . ($_REQUEST['gtotal'] - $_REQUEST['taxtot']) . "', particulars='Inv. No. :$_REQUEST[invno]', type='Dr.', relatedto='$rid'");
	...
	if (isset($_REQUEST['s2'])) {
		if ($_REQUEST['taxtype'] == "GST")
			echo "<script language=\"javascript\">window.open(\"printinvoice.php?sale_id=$id\",\"_blank\");</script>";
		else
			echo "<script language=\"javascript\">window.open(\"printinvoice1.php?sale_id=$id\",\"_blank\");</script>";
	}
...
if (isset($_REQUEST['s4'])) {
	...
	mysqli_query($con, "update billbook set party='" . $party . "', invno='" . $_REQUEST['invno'] . "', invdate='" . $invdate . "',  paidby='" . $paidby . "', roundoff='$_REQUEST[roundoff]', amount='" . $amt . "', chequeno='" . $cheque . "', relatedwith='$rid', spdis='$_REQUEST[spdis]', freight='$_REQUEST[freight]', remark='$_REQUEST[remark]', transport='$_REQUEST[transport]', other='$_REQUEST[other]', taxtype='$_REQUEST[taxtype]', emp_id='$_REQUEST[emp_id]',  comm='$_REQUEST[comm]', oname='$_REQUEST[oname]' where sale_id='$id'");
	...
	header("Location: viewsales.php?msg=set");
	die;
}
?>
<?php
...
while ($f = mysqli_fetch_row($f1)) {
	...
	$query .= "<option value='$f[0]-$f[5]-$c[7]-$f[6]' data-vid='$f[10]'>" . htmlspecialchars("$c[1]-$c[5] $f[2] $f[3]") . "</option>";
}
?>
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Add Sales Bill</li>
			</ul>
			<!-- END BREADCRUMB -->

			<!-- PAGE TITLE -->
			<div class="page-title">
				<h2><span class="fa fa-lsit"></span><?php if (isset($_REQUEST['sale_id'])) echo "Modify Sales Bill";
													else echo "Add New Bill"; ?></h2>
				<br><br><br>
										...
										<div class="row">
											<div class="col-md-12">
												...
												if (isset($_REQUEST['sale_id'])) {
													$p1 = mysqli_query($con, "select * from billbook where sale_id='$_REQUEST[sale_id]'");
													...
													<table class="table table-bordered table-striped table-actions">
														<tbody>
																...
																<td>
																	<div class="form-group">
																		<select class="form-control" name="taxtype" required tabindex='1'>
																			<option <?php if ($p[16] == "GST") { ?> selected='selected' <?php } ?>>GST</option>
																			<option <?php if ($p[16] == "IGST") { ?> selected='selected' <?php } ?>>IGST</option>
																		</select>
																	</div>
																</td>
															</tr>
															...
															?>
																<tr>
																	<th>or New Party</th>
																	<td><input type="text" class="form-control" name="party1" /></td>
																	<th>GST NO.</th>
															...
															<tr>
																...
																<td>
																	<div class="form-group">
																		<select class="form-control" name="paidby" required tabindex='1'>
																			<option value="">--Select--</option>
																			<option value="Credit" <?php if ($p[7] == "Credit") { ?> selected='selected' <?php } ?>>Credit</option>
																			<?php
																...
																<td>
																	<div class="form-group">
																		<input type="text" tabindex='1' class="form-control" name="chequeno" value="<?php echo $p[8]; ?>" onkeyup="return allowOnly10Numeric(this);" oninput="allowOnly10Numeric(this);" />
															...
															<tr>
																...
																<td>
																	<div class="form-group">
																		<select class="form-control" name="emp_id" required tabindex='1'>
																			<option value=''>--Select--</option>
																			<option value='0' <?php if ($p[17] == '0') { ?> selected='selected' <?php } ?>>None</option>
																			<?php
																...
																<td>
																	<div class="form-group">
																		<input type="text" class="form-control" name="comm" value="<?php echo $p[4]; ?>" onkeyup="calc();" tabindex='1' />
																	</div>
																</td>
															</tr>
															<tr>
																	...
																	<div class="table-responsive">
																		<table class="table table-bordered table-striped table-actions" id="input_fields">
																			...
																			<tbody>
																				<?php
																				if (isset($_REQUEST['sale_id'])) {
																					$k1 = mysqli_query($con, "select * from bill_items where sale_id='$p[0]'");
																									...
																									<div class="form-group">
																										<select class="form-control" name="item_id[]" id="item_id<?php echo $a; ?>" onchange='onItemSelect(this);' tabindex='1'>
																											...
																											while ($f = mysqli_fetch_row($f1)) {
																												$c = mysqli_fetch_row(mysqli_query($con, "select * from item_details where item_id='$f[1]'"));
																												if ($k[1] == $f[0])
																													echo "<option value='$f[0]-$f[5]-$c[7]-$f[6]' data-vid='$f[10]' selected>" . htmlspecialchars("$c[1]-$c[5] $f[2] $f[3]") . "</option>";
																												else
															...
															<tr>
																...
																<td>
																	<div class="input-group">
																		<input type="text" class="form-control" name="spdisvalue" id="spdisvalue" onkeyup="calc1();" tabindex='1' style="width:50px;" value="<?php echo $p[9]; ?>" />
															...
															<tr>
																...
																<td>
																	<div class="input-group">
																		<input type="text" tabindex='1' class="form-control" name="freight" id="freight" value="<?php echo $p[11]; ?>" onkeyup="calc();" style="width:100px;" />
																	</div>
																</td>
															</tr>
															<tr>
																...
																<td>
																	<div class="input-group">
																		<input type="text" tabindex='1' class="form-control" name="transport" id="transport" value="<?php echo $p[10]; ?>" onkeyup="calc();" style="width:100px;" />
																	</div>
																</td>
															</tr>
															<tr>
																<th><input type="text" tabindex='1' class="form-control" name="oname" value="<?php echo $p[6]; ?>" style="width:150px;" /></th>
																<td>
																	<div class="input-group">
																		<input type="text" tabindex='1' class="form-control" name="other" id="other" value="<?php echo $p[12]; ?>" onkeyup="calc();" style="width:100px;" />
																	</div>
																</td>
															</tr>
															<tr>
																...
																<td>
																	<div class="input-group">
																		<input type="text" class="form-control" name="roundoff" id="roundoff" value="<?php echo $p[13]; ?>" onkeyup="calc();" style="width:100px;" />
																	</div>
																</td>
															</tr>
															<tr>
