<?php
	...
	{
		$msg="Product Type Updated Successfullly!!!";
	}
	if(isset($_REQUEST['pt_id']))
	{
		mysqli_query($con,"delete from producttype where pt_id='$_REQUEST[pt_id]'");
		$msg1="Product Type Deleted Successfullly!!!";
...
<head>        
	...
	{
			var path="viewprotype.php?pt_id="+row;
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <!-- START PAGE SIDEBAR -->
             <?php $menu2=true; $smenu2="1"; $ssmenu2="12"; include_once("sidebar.php"); ?>
            <!-- END PAGE SIDEBAR -->
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table id="customers2" class="table datatable table-bordered table-striped table-actions">
                                            ...
                                            <tbody>
												<?php
													$d1=mysqli_query($con,"select * from producttype order by ptname");
                                                ...
                                                <tr id="<?php echo $d[0]; ?>">
													...
													<td>
														...
														<button class="btn btn-info btn-rounded btn-condensed btn-sm" onClick="window.open('addprotype.php?pt_id=<?php echo $d[0]; ?>','_self');"><span class="fa fa-pencil"></span></button>
                                                    </td>
                                                </tr>
												<?php
													}
