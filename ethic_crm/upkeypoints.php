...
{   
    ...
    foreach ($bannerIds as $m_id) 
    {
        ...
        mysqli_query($con, "UPDATE matter SET title='$title', desp='$desp'  WHERE m_id=$m_id");
    }
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">Home</a></li>
                <li class="active">Update Key Points</li>
            </ul>
            <!-- END BREADCRUMB -->
            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" method="post" action="upkeypoints.php" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Update</strong> Key Points</h3>
                                </div>
                                <div class="panel-body">
                                    <?php
                                    $data = [];
                                    $result = mysqli_query($con, "SELECT * FROM matter WHERE m_id IN (17,18,19,20)");
