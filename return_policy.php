...
<div>
    ...
    <!-- main slide -->
    <?php
        $query = mysqli_query($con, "SELECT * FROM banner WHERE b_id = 4");
    ...
    <div style="background-image: url('<?php echo $banner; ?>'); " class="position-relative">
        ...
        <div class="px-4">
            <div class="text-white text-center py-51 position-relative">
                <h4 class="fs-30 fw-medium">Return & Refund Policy</h4>
            </div>
        </div>
    </div>
    <!-- end main slide -->
    ...
    <section>
        <div class="container">
            <?php
                $p=mysqli_fetch_assoc(mysqli_query($con,"select * from matter where m_id='2'"));
            ?>
            <div class="my-4 text-muted">
                <h3 class="text-center">Return & Refund Policy</h3>
                <p><?php echo $p['desp']; ?></p>
            </div>
        </div>
    </section>
